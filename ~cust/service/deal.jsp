...
<body>
	...
	<form id="form1" action="service!findall1" method="post">
		...
		<table class="query_form_table" height="53">
			...
			<tr>
				...
				<td><select name="cs.svrStatus">
						<option value="已分配" selected>已分配</option>
				</select>
				</td>
			</tr>
		</table>
			...
			<%-- <s:if test="svrStatus=='已分配'"> --%>
				<tr>
					...
					<td class="list_data_op"><img
						onclick="to('service!findByida?cs.svrId=<s:property value="svrId"/>');"
						src="html/images/bt_deal.gif" class="op_button" /></td>
