...
<body>
	...
	<form id="form1" action="service!findall3" method="post">
		...
		<table class="query_form_table" height="53">
			<tr>
				...
				<th height="28">概要</th>
				<td><input name="cs.svrTitle" value="${cs.svrTitle}" />
				</td>
	...
	<table class="data_list_table">
		...
		<s:iterator value="#request.list1">
			...
			<%-- <s:if test="svrStatus=='已归档'"> --%>
				<tr>
					<td class="list_data_number"><s:property value="svrId" /></td>
					<td class="list_data_text"><s:property value="svrCustName" />
					</td>
					<td class="list_data_ltext"><s:property value="svrTitle" /></td>
					<td class="list_data_text"><s:property value="svrType" /></td>
					...
					<td class="list_data_text"><s:property value="svrStatus" /></td>
					<td class="list_data_op"><img
						onclick="to('service!findByidc?cs.svrId=<s:property value="svrId"/>');"
						title="查看" src="html/images/bt_detail.gif" class="op_button" />
					</td>
				</tr>
			<%-- </s:if> --%>
